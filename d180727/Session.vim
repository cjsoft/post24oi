...
nmap cs <Plug>Csurround
nmap cr <Plug>Coerce
omap c <Plug>(textobj-character-ac)
xmap c <Plug>(textobj-character-ac)
...
wincmd w
argglobal
terminal ++curwin ++cols=119 ++rows=10 
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
